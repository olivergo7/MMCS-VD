...
if __name__ == '__main__':
    ...
    # parser.add_argument('--dir', help='Name of code file', default='../')
    parser.add_argument('--line', help='Line Number for slice start point', type=int, default=1)
    ...
    directory = 'tmp'
    directory_1 = '../raw_data/Devign_c_copy'

    for file_name in os.listdir(directory_1):
        slice_ln = int(args.line)
        code_file_path = os.path.join(directory_1, file_name)
