...
if __name__ == '__main__':
    ...
    parser.add_argument('--code', help='Name of code file', default='0_0.c')
    ...
    #(code, adjacency_list, os.path.join(args.output, file_name), verbose=args.verbose)
